...
public class PAUKS extends CipherSystem {
    ...
    public void enc(String str){
        ...
        C1 = pk_r2.powZn(HashUtil.hashZrArr2Zr(this.getZr(), pk_r1.powZn(sk_s), w)).mul(pk_r3).powZn(r1).getImmutable();
    ...
    public void trap(String str){
        ...
        T1 = g.powZn(r3.div(sk_r2.mul(HashUtil.hashZrArr2Zr(this.getZr(), pk_s.powZn(sk_r1), w)).add(sk_r3))).getImmutable();
