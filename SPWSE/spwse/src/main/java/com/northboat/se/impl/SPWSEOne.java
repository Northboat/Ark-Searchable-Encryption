package com.northboat.se.impl;

import com.northboat.se.CipherSystem;
import com.northboat.util.HashUtil;
...
public class SPWSEOne extends CipherSystem {
    ...
    public SPWSEOne(Field G1, Field GT, Field Zr, Pairing bp, int n, Element g1, Element g2){
        super(G1, GT, Zr, bp, n);
        this.g1 = g1;
        this.g2 = g2;
    }
...
//        Element m = acc.getImmutable();
        ...
        System.out.println("等式右侧: " + this.getGT().newOneElement());
        System.out.println("=====================\n\n");
